...
namespace
{
  ...
  void add_locals(
    Node unifybody, std::vector<Scope>& scopes, BuiltIns builtins);

  void find_free_vars(
    const Node& node, std::vector<Scope>& scopes, BuiltIns builtins)
  {
  ...
  void add_locals(Node unifybody, std::vector<Scope>& scopes, BuiltIns builtins)
  {
  ...
  int preprocess_body(Node node, BuiltIns builtins)
  {
  ...
  int preprocess_value(Node node, BuiltIns builtins)
  {
    std::vector<Scope> scopes;
...
namespace rego
{
  ...
  {
    PassDef locals = {"body_locals", wf_pass_locals, dir::bottomup | dir::once};
